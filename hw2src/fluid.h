...
private:
  ...
  void clearVelocities(int i, int j, int k) {
    set_new_u_plus(i, j, k, 0);
    set_new_v_plus(i, j, k, 0);
    set_new_w_plus(i, j, k, 0);
  }
  // =================
  // ANIMATION HELPERS
  ...
  void CopyVelocities();
  void distribute(int i, int j, int k, double net);
  ...
  // velocity modifiers
  void set_u_plus(int i, int j, int k, double f) { getCell(i,j,k)->set_u_plus(f); }
  void set_v_plus(int i, int j, int k, double f) { getCell(i,j,k)->set_v_plus(f); }
  void set_w_plus(int i, int j, int k, double f) { getCell(i,j,k)->set_w_plus(f); }
  ...
  double getArea(double x, double y, double centerX, double centerY) const;
  double getVolume(double x, double y, double z, double centerX, double centerY, double centerZ) const;
  double get_u_interpolated(int i, int j, int k, int iDelta, int jDelta, int kDelta, int uMod, int vMod, int wMod, double volumes[]) const;
  double get_v_interpolated(int i, int j, int k, int iDelta, int jDelta, int kDelta, int uMod, int vMod, int wMod, double volumes[]) const;
  double get_w_interpolated(int i, int j, int k, int iDelta, int jDelta, int kDelta, int uMod, int vMod, int wMod, double volumes[]) const;
